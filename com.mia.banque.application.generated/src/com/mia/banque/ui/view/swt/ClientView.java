...
public class ClientView extends Shell  implements IClientView{
	...
	public ClientView(Display display, IClient model,  IClientController controller){
	...
	private void createContents(){
		...
		this.Comptes = new List(grpCompte, SWT.BORDER | SWT.V_SCROLL | SWT.SINGLE);
		this.Comptes.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
		
		for (final ICompte elt : this.model.getComptes()) {
			this.Comptes.add(elt.toString());
		}
